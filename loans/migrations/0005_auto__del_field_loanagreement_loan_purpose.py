...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LoanAgreement.loan_purpose'
        db.delete_column('loans_loanagreement', 'loan_purpose')


    def backwards(self, orm):
        
        # Adding field 'LoanAgreement.loan_purpose'
        db.add_column('loans_loanagreement', 'loan_purpose', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
