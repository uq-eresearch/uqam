...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoanAgreement.location'
        db.add_column('loans_loanagreement', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'LoanAgreement.reason'
        db.add_column('loans_loanagreement', 'reason', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'LoanAgreement.returned'
        db.add_column('loans_loanagreement', 'returned', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LoanAgreement.location'
        db.delete_column('loans_loanagreement', 'location')

        # Deleting field 'LoanAgreement.reason'
        db.delete_column('loans_loanagreement', 'reason')

        # Deleting field 'LoanAgreement.returned'
        db.delete_column('loans_loanagreement', 'returned')
    ...
    models = {
        ...
        'loans.loanagreement': {
            ...
            'loan_purpose': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
