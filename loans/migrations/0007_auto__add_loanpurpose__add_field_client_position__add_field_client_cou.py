...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.position'
        db.add_column('loans_client', 'position', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'Client.country'
        db.add_column('loans_client', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Changing field 'Client.address'
        db.alter_column('loans_client', 'address', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Client.position'
        db.delete_column('loans_client', 'position')

        # Deleting field 'Client.country'
        db.delete_column('loans_client', 'country')

        # Changing field 'Client.address'
        db.alter_column('loans_client', 'address', self.gf('django.db.models.fields.CharField')(max_length=300))
