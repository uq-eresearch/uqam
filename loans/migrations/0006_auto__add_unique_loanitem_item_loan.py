...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'LoanItem', fields ['item', 'loan']
        db.create_unique('loans_loanitem', ['item_id', 'loan_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LoanItem', fields ['item', 'loan']
        db.delete_unique('loans_loanitem', ['item_id', 'loan_id'])
