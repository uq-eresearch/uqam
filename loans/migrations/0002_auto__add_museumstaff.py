...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('loans_museumstaff', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('loans', ['MuseumStaff'])


    def backwards(self, orm):
        
        # Deleting model 'MuseumStaff'
        db.delete_table('loans_museumstaff')
    ...
    models = {
        ...
        'cat.museumobject': {
            ...
            'maker_or_artist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cat.Maker']", 'null': 'True', 'blank': 'True'}),
