...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteConfiguration.new_acquisition_image'
        db.alter_column('common_siteconfiguration', 'new_acquisition_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediaman.ArtefactRepresentation'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'SiteConfiguration.new_acquisition_image'
        db.alter_column('common_siteconfiguration', 'new_acquisition_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediaman.ArtefactRepresentation'], null=True))
    ...
    models = {
        ...
        'common.siteconfiguration': {
            ...
            'new_acquisition_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mediaman.ArtefactRepresentation']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
