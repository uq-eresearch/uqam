...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteConfiguration.homepage_item_description'
        db.delete_column('common_siteconfiguration', 'homepage_item_description')

        # Deleting field 'SiteConfiguration.homepage_item'
        db.delete_column('common_siteconfiguration', 'homepage_item_id')

        # Adding field 'SiteConfiguration.new_acquisition'
        db.add_column('common_siteconfiguration', 'new_acquisition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cat.MuseumObject']),
                      keep_default=False)

        # Adding field 'SiteConfiguration.new_acquisition_text'
        db.add_column('common_siteconfiguration', 'new_acquisition_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SiteConfiguration.new_acquisition_image'
        db.add_column('common_siteconfiguration', 'new_acquisition_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediaman.ArtefactRepresentation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SiteConfiguration.homepage_item_description'
        db.add_column('common_siteconfiguration', 'homepage_item_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SiteConfiguration.homepage_item'
        db.add_column('common_siteconfiguration', 'homepage_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cat.MuseumObject']),
                      keep_default=False)

        # Deleting field 'SiteConfiguration.new_acquisition'
        db.delete_column('common_siteconfiguration', 'new_acquisition_id')

        # Deleting field 'SiteConfiguration.new_acquisition_text'
        db.delete_column('common_siteconfiguration', 'new_acquisition_text')

        # Deleting field 'SiteConfiguration.new_acquisition_image'
        db.delete_column('common_siteconfiguration', 'new_acquisition_image_id')
    ...
    models = {
        ...
        'cat.museumobject': {
            ...
            'old_storage_bay': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'old_storage_section': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'old_storage_shelf_box_drawer': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'old_storage_unit': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            ...
            'storage_row': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'storage_shelf_drawer': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
        ...
        'common.siteconfiguration': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_acquisition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cat.MuseumObject']"}),
            'new_acquisition_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mediaman.ArtefactRepresentation']", 'null': 'True'}),
            'new_acquisition_text': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
