...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cat_museumobject', (
            ...
            ('functional_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.FunctionalCategory'], null=True, blank=True)),
            ('artefact_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.ArtefactType'])),
            ...
            ('cultural_bloc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.CulturalBloc'], null=True, blank=True)),
