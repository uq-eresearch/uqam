...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cat_museumobject', 'old_maker',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='old_maker', null=True, to=orm['parties.Maker']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MuseumObject.old_maker'
        db.delete_column('cat_museumobject', 'old_maker_id')
