...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cat_museumobject', 'recorded_use', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'cat.museumobject': {
            ...
            'recorded_use': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
