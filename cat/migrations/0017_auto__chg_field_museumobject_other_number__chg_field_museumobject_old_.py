...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MuseumObject.other_number'
        db.alter_column('cat_museumobject', 'other_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MuseumObject.old_registration_number'
        db.alter_column('cat_museumobject', 'old_registration_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MuseumObject.reg_counter'
        db.alter_column('cat_museumobject', 'reg_counter', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'MuseumObject.other_number'
        db.alter_column('cat_museumobject', 'other_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'MuseumObject.old_registration_number'
        db.alter_column('cat_museumobject', 'old_registration_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'MuseumObject.reg_counter'
        db.alter_column('cat_museumobject', 'reg_counter', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'cat.museumobject': {
            ...
            'old_registration_number': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
            'other_number': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
            ...
            'reg_counter': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
