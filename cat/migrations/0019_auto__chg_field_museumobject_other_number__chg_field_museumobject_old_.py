...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cat_museumobject', 'other_number', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.old_registration_number'
        db.alter_column('cat_museumobject', 'old_registration_number', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.reg_counter'
        db.alter_column('cat_museumobject', 'reg_counter', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'MuseumObject.other_number'
        db.alter_column('cat_museumobject', 'other_number', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'MuseumObject.old_registration_number'
        db.alter_column('cat_museumobject', 'old_registration_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MuseumObject.reg_counter'
        db.alter_column('cat_museumobject', 'reg_counter', self.gf('django.db.models.fields.CharField')(max_length=20))
