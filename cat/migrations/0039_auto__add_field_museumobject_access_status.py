...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cat_museumobject', 'access_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.AccessStatus'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.access_status'
        db.delete_column('cat_museumobject', 'access_status_id')
