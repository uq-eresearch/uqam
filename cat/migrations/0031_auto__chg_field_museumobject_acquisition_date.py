...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cat_museumobject', 'acquisition_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'MuseumObject.acquisition_date'
        db.alter_column('cat_museumobject', 'acquisition_date', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
