...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.reg_counter'
        db.add_column('cat_museumobject', 'reg_counter', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.reg_counter'
        db.delete_column('cat_museumobject', 'reg_counter')
