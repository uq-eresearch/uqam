...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cat_person', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))


    def backwards(self, orm):
        
        # Changing field 'Person.name'
        db.alter_column('cat_person', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
