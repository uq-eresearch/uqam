...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MuseumObject.how_source_obtained'
        db.delete_column('cat_museumobject', 'how_source_obtained')

        # Adding field 'MuseumObject.how_donor_obtained'
        db.add_column('cat_museumobject', 'how_donor_obtained', self.gf('django.db.models.fields.related.ForeignKey')(related_name='donor_obtained', null=True, to=orm['cat.Obtained']), keep_default=False)

        # Adding field 'MuseumObject.how_collector_obtained'
        db.add_column('cat_museumobject', 'how_collector_obtained', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collector_obtained', null=True, to=orm['cat.Obtained']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MuseumObject.how_source_obtained'
        raise RuntimeError("Cannot reverse this migration. 'MuseumObject.how_source_obtained' and its values cannot be restored.")

        # Deleting field 'MuseumObject.how_donor_obtained'
        db.delete_column('cat_museumobject', 'how_donor_obtained_id')

        # Deleting field 'MuseumObject.how_collector_obtained'
        db.delete_column('cat_museumobject', 'how_collector_obtained_id')
