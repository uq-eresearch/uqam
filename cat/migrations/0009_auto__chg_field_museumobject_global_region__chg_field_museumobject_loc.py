...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MuseumObject.global_region'
        db.alter_column('cat_museumobject', 'global_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.GlobalRegion'], null=True, on_delete=models.SET_NULL))

        # Changing field 'MuseumObject.locality'
        db.alter_column('cat_museumobject', 'locality_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.Locality'], null=True, on_delete=models.SET_NULL))

        # Changing field 'MuseumObject.region_district'
        db.alter_column('cat_museumobject', 'region_district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.RegionDistrict'], null=True, on_delete=models.SET_NULL))

        # Changing field 'MuseumObject.state_province'
        db.alter_column('cat_museumobject', 'state_province_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.StateProvince'], null=True, on_delete=models.SET_NULL))

        # Changing field 'MuseumObject.country'
        db.alter_column('cat_museumobject', 'country_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.Country'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'MuseumObject.global_region'
        db.alter_column('cat_museumobject', 'global_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.GlobalRegion'], null=True, on_delete=models.PROTECT))

        # Changing field 'MuseumObject.locality'
        db.alter_column('cat_museumobject', 'locality_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.Locality'], null=True, on_delete=models.PROTECT))

        # Changing field 'MuseumObject.region_district'
        db.alter_column('cat_museumobject', 'region_district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.RegionDistrict'], null=True, on_delete=models.PROTECT))

        # Changing field 'MuseumObject.state_province'
        db.alter_column('cat_museumobject', 'state_province_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.StateProvince'], null=True, on_delete=models.PROTECT))

        # Changing field 'MuseumObject.country'
        db.alter_column('cat_museumobject', 'country_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['location.Country'], null=True, on_delete=models.PROTECT))
