...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.category_illustrated'
        db.add_column('cat_museumobject', 'category_illustrated', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'MuseumObject.artefact_illustrated'
        db.add_column('cat_museumobject', 'artefact_illustrated', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.category_illustrated'
        db.delete_column('cat_museumobject', 'category_illustrated')

        # Deleting field 'MuseumObject.artefact_illustrated'
        db.delete_column('cat_museumobject', 'artefact_illustrated')
