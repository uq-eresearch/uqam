...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cat_museumobject', 'how_donor_obtained')

        # Deleting field 'MuseumObject.how_collector_obtained'
        db.delete_column('cat_museumobject', 'how_collector_obtained')


    def backwards(self, orm):
        
        # Adding field 'MuseumObject.how_donor_obtained'
        db.add_column('cat_museumobject', 'how_donor_obtained', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'MuseumObject.how_collector_obtained'
        db.add_column('cat_museumobject', 'how_collector_obtained', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
