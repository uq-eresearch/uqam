...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MuseumObject', fields ['public']
        db.create_index('cat_museumobject', ['public'])


    def backwards(self, orm):
        # Removing index on 'MuseumObject', fields ['public']
        db.delete_index('cat_museumobject', ['public'])
