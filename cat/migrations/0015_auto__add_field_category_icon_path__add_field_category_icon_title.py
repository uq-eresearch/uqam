...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.icon_path'
        db.add_column('cat_category', 'icon_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Category.icon_title'
        db.add_column('cat_category', 'icon_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.icon_path'
        db.delete_column('cat_category', 'icon_path')

        # Deleting field 'Category.icon_title'
        db.delete_column('cat_category', 'icon_title')
