...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MuseumObject.access_status'
        db.delete_column('cat_museumobject', 'access_status')

        # Adding field 'MuseumObject.loan_status'
        db.add_column('cat_museumobject', 'loan_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.LoanStatus'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'MuseumObject.access_status'
        db.add_column('cat_museumobject', 'access_status', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Deleting field 'MuseumObject.loan_status'
        db.delete_column('cat_museumobject', 'loan_status_id')
