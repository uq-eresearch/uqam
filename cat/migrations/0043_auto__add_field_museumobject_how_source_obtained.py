...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.how_source_obtained'
        db.add_column('cat_museumobject', 'how_source_obtained', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_obtained', null=True, to=orm['cat.Obtained']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.how_source_obtained'
        db.delete_column('cat_museumobject', 'how_source_obtained_id')
