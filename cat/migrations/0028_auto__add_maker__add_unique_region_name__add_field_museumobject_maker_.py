...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Maker'
        db.create_table('cat_maker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('cat', ['Maker'])

        # Adding unique constraint on 'Region', fields ['name']
        db.create_unique('cat_region', ['name'])

        # Adding field 'MuseumObject.maker'
        db.add_column('cat_museumobject', 'maker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.Maker'], null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'Person', fields ['name']
        db.create_unique('cat_person', ['name'])

        # Adding unique constraint on 'FunctionalCategory', fields ['name']
        db.create_unique('cat_functionalcategory', ['name'])

        # Adding unique constraint on 'ArtefactType', fields ['name']
        db.create_unique('cat_artefacttype', ['name'])

        # Adding unique constraint on 'CulturalBloc', fields ['name']
        db.create_unique('cat_culturalbloc', ['name'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'CulturalBloc', fields ['name']
        db.delete_unique('cat_culturalbloc', ['name'])

        # Removing unique constraint on 'ArtefactType', fields ['name']
        db.delete_unique('cat_artefacttype', ['name'])

        # Removing unique constraint on 'FunctionalCategory', fields ['name']
        db.delete_unique('cat_functionalcategory', ['name'])
        ...
        db.delete_unique('cat_region', ['name'])

        # Deleting model 'Maker'
        db.delete_table('cat_maker')

        # Deleting field 'MuseumObject.maker'
        db.delete_column('cat_museumobject', 'maker_id')
    ...
    models = {
        ...
        'cat.museumobject': {
            ...
            'maker_or_artist': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
