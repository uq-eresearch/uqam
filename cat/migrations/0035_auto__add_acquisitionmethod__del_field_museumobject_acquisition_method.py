...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cat_museumobject', 'acquisition_method')
    ...
    def backwards(self, orm):
        ...
        db.add_column('cat_museumobject', 'acquisition_method', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
