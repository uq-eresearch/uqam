...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RecordStatus'
        db.create_table('cat_recordstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('cat', ['RecordStatus'])

        # Adding field 'MuseumObject.record_status'
        db.add_column('cat_museumobject', 'record_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.RecordStatus'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RecordStatus'
        db.delete_table('cat_recordstatus')

        # Deleting field 'MuseumObject.record_status'
        db.delete_column('cat_museumobject', 'record_status_id')
