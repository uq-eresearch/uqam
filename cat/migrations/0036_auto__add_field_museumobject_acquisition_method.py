...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.acquisition_method'
        db.add_column('cat_museumobject', 'acquisition_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.AcquisitionMethod'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.acquisition_method'
        db.delete_column('cat_museumobject', 'acquisition_method_id')
