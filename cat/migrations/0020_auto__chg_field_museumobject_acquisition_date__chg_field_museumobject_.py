...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MuseumObject.acquisition_date'
        db.alter_column('cat_museumobject', 'acquisition_date', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.access_status'
        db.alter_column('cat_museumobject', 'access_status', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.source'
        db.alter_column('cat_museumobject', 'source', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.raw_material'
        db.alter_column('cat_museumobject', 'raw_material', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.site_name_number'
        db.alter_column('cat_museumobject', 'site_name_number', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.how_source_obtained'
        db.alter_column('cat_museumobject', 'how_source_obtained', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.recorded_use'
        db.alter_column('cat_museumobject', 'recorded_use', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.loan_status'
        db.alter_column('cat_museumobject', 'loan_status', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.when_collector_obtained'
        db.alter_column('cat_museumobject', 'when_collector_obtained', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.how_collector_obtained'
        db.alter_column('cat_museumobject', 'how_collector_obtained', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MuseumObject.acquisition_method'
        db.alter_column('cat_museumobject', 'acquisition_method', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'MuseumObject.acquisition_date'
        db.alter_column('cat_museumobject', 'acquisition_date', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.access_status'
        db.alter_column('cat_museumobject', 'access_status', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.source'
        db.alter_column('cat_museumobject', 'source', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.raw_material'
        db.alter_column('cat_museumobject', 'raw_material', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.site_name_number'
        db.alter_column('cat_museumobject', 'site_name_number', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.how_source_obtained'
        db.alter_column('cat_museumobject', 'how_source_obtained', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.recorded_use'
        db.alter_column('cat_museumobject', 'recorded_use', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.loan_status'
        db.alter_column('cat_museumobject', 'loan_status', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.when_collector_obtained'
        db.alter_column('cat_museumobject', 'when_collector_obtained', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.how_collector_obtained'
        db.alter_column('cat_museumobject', 'how_collector_obtained', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MuseumObject.acquisition_method'
        db.alter_column('cat_museumobject', 'acquisition_method', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'cat.category': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('slug', 'parent'),)", 'object_name': 'Category'},
        ...
        'cat.museumobject': {
            ...
            'maker_or_artist': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'raw_material': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'recorded_use': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'site_name_number': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
