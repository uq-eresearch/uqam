...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.registered_by'
        db.add_column('cat_museumobject', 'registered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loans.MuseumStaff'], null=True), keep_default=False)

        # Adding field 'MuseumObject.registration_date'
        db.add_column('cat_museumobject', 'registration_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.registered_by'
        db.delete_column('cat_museumobject', 'registered_by_id')

        # Deleting field 'MuseumObject.registration_date'
        db.delete_column('cat_museumobject', 'registration_date')
