...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('cat_museumobject', 'storage_section', 'old_storage_section')
        db.rename_column('cat_museumobject', 'storage_unit', 'old_storage_unit')
        db.rename_column('cat_museumobject', 'storage_bay', 'old_storage_bay')
        db.rename_column('cat_museumobject', 'storage_shelf_box_drawer', 'old_storage_shelf_box_drawer')

    def backwards(self, orm):
        db.rename_column('cat_museumobject', 'old_storage_section', 'storage_section')
        db.rename_column('cat_museumobject', 'old_storage_unit', 'storage_unit')
        db.rename_column('cat_museumobject', 'old_storage_bay', 'storage_bay')
        db.rename_column('cat_museumobject', 'old_storage_shelf_box_drawer', 'storage_shelf_box_drawer')
