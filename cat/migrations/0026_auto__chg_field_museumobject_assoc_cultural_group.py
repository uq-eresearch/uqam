...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MuseumObject.assoc_cultural_group'
        db.alter_column('cat_museumobject', 'assoc_cultural_group', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'MuseumObject.assoc_cultural_group'
        db.alter_column('cat_museumobject', 'assoc_cultural_group', self.gf('django.db.models.fields.CharField')(max_length=50))
