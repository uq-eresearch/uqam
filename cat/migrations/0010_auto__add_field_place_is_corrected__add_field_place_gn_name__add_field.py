...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.is_corrected'
        db.add_column('cat_place', 'is_corrected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Place.gn_name'
        db.add_column('cat_place', 'gn_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Place.gn_id'
        db.add_column('cat_place', 'gn_id', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.is_corrected'
        db.delete_column('cat_place', 'is_corrected')

        # Deleting field 'Place.gn_name'
        db.delete_column('cat_place', 'gn_name')

        # Deleting field 'Place.gn_id'
        db.delete_column('cat_place', 'gn_id')
