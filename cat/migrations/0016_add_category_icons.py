...
icons_data = {
    ...
    "Media": ("images/categories/media-thumb.jpg", "Audio tape | South East Queensland, Australia | Dr L. P. Winterbotham and Gaiarbau (Willy MacKenzie) | Donated by Dr L. P. Winterbotham, 1950"),
    "Model/Game": ("images/categories/modelgame-thumb.jpg", "Model house | Papua New Guinea | Unknown maker(s) | Donated by QANTAS, 1950"),
    "Painting/Paper": ("images/categories/paintingpaper-thumb.jpg", "Postcard | Port Moresby, Papua New Guinea | Unknown photographer | Unknown provenance"),
    "Photograph": ("images/categories/photograph-thumb.jpg", "Photograph, c. 1915 | Balimo Bay, Western Province, Papua New Guinea | A.P. Lyons | Donated by Mrs E. Lee, 1950"),
    "Raw Material": ("images/categories/rawmaterials-thumb.jpg", "Red ochre | Bentinck Island, Queensland, Australia | Unknown maker(s) | Donated by Reverend J. B. McCarthy, 1950"),
    "Sculpture/Carving": ("images/categories/sculpturecarving-thumb.jpg", "Carving | Milne Bay Province, Papua New Guinea | Unknown maker(s) | Purchased from Australian Board of Missions, 1948"),
    "Sound": ("images/categories/sound-thumb.jpg", "Drum | Papua New Guinea | Unknown maker(s) | Donated by Barney Shay, 1951"),
}
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for name, data in icons_data.items():
            print name
            categ = orm['cat.Category'].objects.get(name=name)
            categ.icon_path = data[0]
            categ.icon_title = data[1]
            categ.save()
