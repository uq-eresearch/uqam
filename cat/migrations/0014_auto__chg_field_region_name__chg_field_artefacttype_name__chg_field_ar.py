...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cat_region', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ArtefactType.name'
        db.alter_column('cat_artefacttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'ArtefactType.see_also'
        db.alter_column('cat_artefacttype', 'see_also', self.gf('django.db.models.fields.CharField')(max_length=60))


    def backwards(self, orm):
        
        # Changing field 'Region.name'
        db.alter_column('cat_region', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ArtefactType.name'
        db.alter_column('cat_artefacttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ArtefactType.see_also'
        db.alter_column('cat_artefacttype', 'see_also', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        'cat.artefacttype': {
            ...
            'see_also': ('django.db.models.fields.CharField', [], {'max_length': '60', 'blank': 'True'})
        },
        'cat.category': {
