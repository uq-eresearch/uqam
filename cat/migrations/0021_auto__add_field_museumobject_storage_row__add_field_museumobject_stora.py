...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MuseumObject.storage_row'
        db.add_column('cat_museumobject', 'storage_row',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'MuseumObject.storage_bay'
        db.add_column('cat_museumobject', 'storage_bay',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'MuseumObject.storage_shelf_drawer'
        db.add_column('cat_museumobject', 'storage_shelf_drawer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MuseumObject.storage_row'
        db.delete_column('cat_museumobject', 'storage_row')

        # Deleting field 'MuseumObject.storage_bay'
        db.delete_column('cat_museumobject', 'storage_bay')

        # Deleting field 'MuseumObject.storage_shelf_drawer'
        db.delete_column('cat_museumobject', 'storage_shelf_drawer')
