...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MuseumObject.reg_info'
        db.add_column('cat_museumobject', 'reg_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'MuseumObject.manufacture_technique'
        db.add_column('cat_museumobject', 'manufacture_technique', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'MuseumObject.creation_date'
        db.add_column('cat_museumobject', 'creation_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'MuseumObject.significance'
        db.add_column('cat_museumobject', 'significance', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MuseumObject.reg_info'
        db.delete_column('cat_museumobject', 'reg_info')

        # Deleting field 'MuseumObject.manufacture_technique'
        db.delete_column('cat_museumobject', 'manufacture_technique')

        # Deleting field 'MuseumObject.creation_date'
        db.delete_column('cat_museumobject', 'creation_date')

        # Deleting field 'MuseumObject.significance'
        db.delete_column('cat_museumobject', 'significance')
