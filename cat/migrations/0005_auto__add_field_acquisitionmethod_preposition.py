...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AcquisitionMethod.preposition'
        db.add_column('cat_acquisitionmethod', 'preposition', self.gf('django.db.models.fields.CharField')(default='by', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AcquisitionMethod.preposition'
        db.delete_column('cat_acquisitionmethod', 'preposition')
