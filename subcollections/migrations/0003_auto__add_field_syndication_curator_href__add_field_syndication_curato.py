...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Syndication.curator_href'
        db.add_column('subcollections_syndication', 'curator_href',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Syndication.curator_name'
        db.add_column('subcollections_syndication', 'curator_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Syndication.curator_href'
        db.delete_column('subcollections_syndication', 'curator_href')

        # Deleting field 'Syndication.curator_name'
        db.delete_column('subcollections_syndication', 'curator_name')
