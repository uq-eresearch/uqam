...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.rights'
        db.alter_column('subcollections_collection', 'rights', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Collection.access_rights'
        db.alter_column('subcollections_collection', 'access_rights', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Collection.rights'
        db.alter_column('subcollections_collection', 'rights', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Collection.access_rights'
        db.alter_column('subcollections_collection', 'access_rights', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'subcollections.collection': {
            ...
            'access_rights': ('django.db.models.fields.TextField', [], {}),
            ...
            'rights': ('django.db.models.fields.TextField', [], {}),
            'syndication_result': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'subcollections.syndication': {
            'Meta': {'object_name': 'Syndication'},
            'curator_href': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'curator_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
