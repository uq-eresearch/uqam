...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subcollections_collection', (
            ...
            ('rights', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('access_rights', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('edit_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('last_published', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_published', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('last_syndicated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('subcollections', ['Collection'])

        # Adding M2M table for field items on 'Collection'
        db.create_table('subcollections_collection_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['subcollections.collection'], null=False)),
            ('museumobject', models.ForeignKey(orm['cat.museumobject'], null=False))
        ))
        db.create_unique('subcollections_collection_items', ['collection_id', 'museumobject_id'])

        # Adding model 'Syndication'
        db.create_table('subcollections_syndication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remote_url', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ...
        db.send_create_signal('subcollections', ['Syndication'])


    def backwards(self, orm):
        # Deleting model 'Collection'
        db.delete_table('subcollections_collection')

        # Removing M2M table for field items on 'Collection'
        db.delete_table('subcollections_collection_items')

        # Deleting model 'Syndication'
        db.delete_table('subcollections_syndication')
    ...
    models = {
        ...
        'subcollections.collection': {
            ...
            'access_rights': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'edit_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_syndicated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'collections'", 'blank': 'True', 'to': "orm['cat.MuseumObject']"}),
            'last_published': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_syndicated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'rights': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'subcollections.syndication': {
            'Meta': {'object_name': 'Syndication'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'remote_url': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        }
    }

    complete_apps = ['subcollections']