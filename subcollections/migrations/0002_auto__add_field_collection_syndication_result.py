...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.syndication_result'
        db.add_column('subcollections_collection', 'syndication_result',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.syndication_result'
        db.delete_column('subcollections_collection', 'syndication_result')
