...
class XSessionMiddleware(object):
    ...
    Allows sharing a session cookie between multiple domains.

    Works by letting the page template include a dynamic javascript file
    generated by this middleware, from the alternate domains. The javascript
    is then adds the session cookie for the new domain.
    """
