...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mediaman_document', 'upload_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 5, 1, 10, 39, 15, 740599), blank=True), keep_default=False)

        # Adding field 'Document.uploaded_by'
        db.add_column('mediaman_document', 'uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Document.original_path'
        db.add_column('mediaman_document', 'original_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Document.original_filedate'
        db.add_column('mediaman_document', 'original_filedate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Changing field 'Document.filesize'
        db.alter_column('mediaman_document', 'filesize', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Deleting field 'ArtefactRepresentation.creation_date'
        db.delete_column('mediaman_artefactrepresentation', 'creation_date')

        # Adding field 'ArtefactRepresentation.upload_date'
        db.add_column('mediaman_artefactrepresentation', 'upload_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 5, 1, 10, 40, 39, 332620), blank=True), keep_default=False)

        # Adding field 'ArtefactRepresentation.uploaded_by'
        db.add_column('mediaman_artefactrepresentation', 'uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'ArtefactRepresentation.original_path'
        db.add_column('mediaman_artefactrepresentation', 'original_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'ArtefactRepresentation.original_filedate'
        db.add_column('mediaman_artefactrepresentation', 'original_filedate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Changing field 'ArtefactRepresentation.image'
        db.alter_column('mediaman_artefactrepresentation', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'ArtefactRepresentation.filesize'
        db.alter_column('mediaman_artefactrepresentation', 'filesize', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'Document.creation_date'
        db.add_column('mediaman_document', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 5, 1, 10, 39, 10, 132551), blank=True), keep_default=False)

        # Deleting field 'Document.upload_date'
        db.delete_column('mediaman_document', 'upload_date')

        # Deleting field 'Document.uploaded_by'
        db.delete_column('mediaman_document', 'uploaded_by_id')

        # Deleting field 'Document.original_path'
        db.delete_column('mediaman_document', 'original_path')

        # Deleting field 'Document.original_filedate'
        db.delete_column('mediaman_document', 'original_filedate')

        # Changing field 'Document.filesize'
        db.alter_column('mediaman_document', 'filesize', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Adding field 'ArtefactRepresentation.creation_date'
        db.add_column('mediaman_artefactrepresentation', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 5, 1, 10, 40, 32, 692825), blank=True), keep_default=False)

        # Deleting field 'ArtefactRepresentation.upload_date'
        db.delete_column('mediaman_artefactrepresentation', 'upload_date')

        # Deleting field 'ArtefactRepresentation.uploaded_by'
        db.delete_column('mediaman_artefactrepresentation', 'uploaded_by_id')

        # Deleting field 'ArtefactRepresentation.original_path'
        db.delete_column('mediaman_artefactrepresentation', 'original_path')

        # Deleting field 'ArtefactRepresentation.original_filedate'
        db.delete_column('mediaman_artefactrepresentation', 'original_filedate')

        # Changing field 'ArtefactRepresentation.image'
        db.alter_column('mediaman_artefactrepresentation', 'image', self.gf('mediaman.thumbs.ImageWithThumbsField')(max_length=100, name='image', sizes=((64, 64), (400, 350))))

        # Changing field 'ArtefactRepresentation.filesize'
        db.alter_column('mediaman_artefactrepresentation', 'filesize', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'mediaman.artefactrepresentation': {
            ...
            'mime_type': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
