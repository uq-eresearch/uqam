...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ArtefactRepresentation'
        db.create_table('mediaman_artefactrepresentation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('image', self.gf('mediaman.thumbs.ImageWithThumbsField')(max_length=100, name='image', sizes=((64, 64), (400, 350)))),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('artefact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cat.MuseumObject'])),
        ))
        db.send_create_signal('mediaman', ['ArtefactRepresentation'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ArtefactRepresentation'
        db.delete_table('mediaman_artefactrepresentation')
