...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArtefactRepresentation.public'
        db.add_column('mediaman_artefactrepresentation', 'public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ArtefactRepresentation.public'
        db.delete_column('mediaman_artefactrepresentation', 'public')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 14, 17, 1, 787108)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 14, 17, 1, 787036)'}),
